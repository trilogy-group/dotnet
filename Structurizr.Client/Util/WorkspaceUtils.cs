...
namespace Structurizr
{
    ...
    public class WorkspaceUtils
    {
        ...
        public async static Task<Workspace> LoadWorkspaceFromJsonAsync(FileInfo file)
        {
            if (file == null)
            {
            ...
            return await new JsonReader().ReadAsync(new StringReader(content));
        }
        ...
        public static async Task SaveWorkspaceToJsonAsync(Workspace workspace, FileInfo file)
        {
            if (workspace == null)
            {
            ...
            {
                await new JsonWriter(true).WriteAsync(workspace, writer);
            }
        }
        ...
        public static async Task PrintWorkspaceAsJson(Workspace workspace)
        {
