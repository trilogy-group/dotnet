...
namespace Structurizr.View
{
    ...
    /// </summary>
    [DataContract]
    public partial class ComponentView :  IEquatable<ComponentView>
    {
        /// <summary>
        ...
        /// <param name="ContainerId">The ID of the container this view is associated with..</param>
        ...
        /// </summary>
        /// <value>The ID of the container this view is associated with.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ComponentView);
        }

        /// <summary>
        /// Returns true if ComponentView instances are equal
        /// </summary>
        /// <param name="other">Instance of ComponentView to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComponentView other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
