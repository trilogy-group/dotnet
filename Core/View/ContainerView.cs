...
namespace Structurizr.View
{
    ...
    /// </summary>
    [DataContract]
    public partial class ContainerView :  IEquatable<ContainerView>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContainerView" />class.
        /// </summary>
        ...
        public ContainerView(string Key = null, string SoftwareSystemId = null, string PaperSize = null, List<ElementInView> Elements = null, List<RelationshipInView> Relationships = null)
        {
            this.Key = Key;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ContainerView);
        }

        /// <summary>
        /// Returns true if ContainerView instances are equal
        /// </summary>
        /// <param name="other">Instance of ContainerView to be compared</param>
        /// <returns>Boolean</returns>
